...
fi1 = np.radians([-25, -10, 0, 10, 25])
fi2 = np.radians([-25, 0, 25])
fi3 = np.radians([-25, -10, 0, 10, 15, 20, 25])

alpha1 = np.radians(
    [-20, -15, -10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 70, 80, 90]
)
alpha2 = np.radians([-20, -15, -10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45])

beta1 = np.radians(
    [-30, -25, -20, -15, -10, -8, -6, -4, -2, 0, 2, 4, 6, 8, 10, 15, 20, 25, 30]
)

Cx1 = np.zeros((5, 20, 19))
Cy1 = np.zeros((5, 20, 19))
Cx_nos1 = np.zeros((14, 19))

mx1 = np.zeros((3, 20, 19))
my1 = np.zeros((3, 20, 19))
mz1 = np.zeros((5, 20, 19))
